    ...
    <Section id="about">
      ...
      <div className="max-w-4xl mx-auto" style={{ color: SITE_TEXT_COLOR }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          <div className="text-center p-6 rounded-lg" style={{ border: `1px solid ${SITE_BORDER_COLOR}` }}>
            <h3 className="text-xl font-semibold mb-4" style={{ color: SITE_HEADER_COLOR }}>
              Innovation
            </h3>
            <p>Constantly exploring new technologies and pushing creative boundaries.</p>
          </div>
          <div className="text-center p-6 rounded-lg" style={{ border: `1px solid ${SITE_BORDER_COLOR}` }}>
            <h3 className="text-xl font-semibold mb-4" style={{ color: SITE_HEADER_COLOR }}>
              Leadership
            </h3>
            <p>Building and leading teams to create exceptional digital experiences.</p>
          </div>
          <div className="text-center p-6 rounded-lg" style={{ border: `1px solid ${SITE_BORDER_COLOR}` }}>
            <h3 className="text-xl font-semibold mb-4" style={{ color: SITE_HEADER_COLOR }}>
              Vision
            </h3>
            <p>Focused on the future of gaming, blockchain, and interactive entertainment.</p>
          </div>
        </div>
      </div>
    </Section>
